...
const REGISTRY = [
  { id: 'add',        label: 'Add',        icon: '＋', accent: '#34d399', Component: AddTemplate },
  { id: 'greet',      label: 'Greeter',    icon: '👋', accent: '#fbbf24', Component: GreetTemplate },
  { id: 'stats',      label: 'Stats',      icon: '📊', accent: '#f472b6', Component: StatsTemplate },
  { id: 'fibonacci',  label: 'Fibonacci',  icon: '🌀', accent: '#818cf8', Component: FibTemplate },
  { id: 'palindrome', label: 'Palindrome', icon: '🔁', accent: '#38bdf8', Component: PalindromeTemplate },
];
    ...
    <>
      ...
      <div style={{
        ...
        <aside style={{
          ...
          {/* Branding */}
          <div style={{ padding: '22px 18px 16px', borderBottom: '1px solid #0f1f35' }}>
            <div style={{
            ...
            {REGISTRY.map(({ id, label, icon, accent }) => {
              ...
              return (
                <button
                  ...
                  onMouseEnter={e => { if (!isActive) e.currentTarget.style.background = '#0f1f35'; }}
          ...
          <div style={{
            ...
            Each template lazy-loads<br />on first click only.
          </div>
        </aside>
        ...
        <main style={{
          ...
          {activeId === null && (
            <div style={{
              ...
              <div style={{
                fontFamily: "'Fira Code', monospace",
                fontSize: 12, color: '#111827', lineHeight: 1.9,
              }}>
                Each component mounts on first click<br />
